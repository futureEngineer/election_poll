...
/*            $output = $this->CI->load->view($this->master, $this->output, true);
			$find=array("\r","\n","	",'  ');
	  		$replace=array('','','','');
	  ...
	  //$find=array("nav_button");
	  //$replace=array('');
      //$output=str_ireplace($find, $replace, $output,$count);
   ...
   function _build_content($region, $wrapper = NULL, $attributes = NULL)
   {
	...
	function render_page($page, $page_elements=array() ) {
		isset($page_elements['between_head_tags']) 	? 0 : $page_elements['between_head_tags']='';
		isset($page_elements['title']) 				? 0 : $page_elements['title']='';
		isset($page_elements['meta_keywords']) 	? 0 : $page_elements['meta_keywords']='';
		isset($page_elements['meta_description']) ? 0 : $page_elements['meta_description']='';
		isset($page_elements['before_body_end_tag']) ? 0 : $page_elements['before_body_end_tag']='';
		isset($page_elements['google_analytics']) 	? 0 : $page_elements['google_analytics']='';
		
		$this->write('between_head_tags',$page_elements['between_head_tags']);
		$this->write('title',$page_elements['title']);
		$this->write('meta_keywords',$page_elements['meta_keywords']);
		$this->write('meta_description',$page_elements['meta_description']);
		$this->write('before_body_end_tag',$page_elements['before_body_end_tag']);
		$this->write('google_analytics',$page_elements['google_analytics']);
		
		//added by Cary Buchmann. June 23, 2011. Added to allow lower content regions into the templating area
		if(isset($page_elements['lower_content_region']) && $page_elements['lower_content_region'] != null)
			$page_elements['lower_content_region'] = $this->write_view('lower_content_region', $page_elements['lower_content_region'], $page_elements);
		
		$this->write_view('content', $page, $page_elements);
